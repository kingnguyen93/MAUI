...
/// </summary>
public class ShortToBoolInvertedConverter : BaseConverter<short, bool>
{
    /// <inheritdoc/>
    ...
    public override bool ConvertFrom(short value, CultureInfo culture = null) => value is not 1;
